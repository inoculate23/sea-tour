...
const HeroSection: React.FC = () => {
  ...
  return (
   ...
   <iframe title="Thai Monkey Mask" frameBorder="0" src="https://sketchfab.com/models/cbdc5fe616f946e0950ad6f01cba5e53/embed?autostart=1&transparent=1&ui_theme=dark"> 
 </iframe> 
    </div>
